...
These issues were created after checking for existing duplicates.

## Issue List

| Issue | Title | Purpose |
| --- | --- | --- |
| [#4](https://github.com/smarquez1/smarquez1/issues/4) | Define portfolio content model | Finalize sections, public claims, timeline fields, and privacy boundaries. |
| [#5](https://github.com/smarquez1/smarquez1/issues/5) | Create visual direction and mockup prompts | Document style direction, prompt strategy, and mockup review criteria. |
| [#2](https://github.com/smarquez1/smarquez1/issues/2) | Generate homepage desktop and mobile mockups | Produce approved image mockups before implementation. |
| [#6](https://github.com/smarquez1/smarquez1/issues/6) | Set up static frontend build | Add Vite, Tailwind, base HTML, and GitHub Pages workflow. |
...
| [#11](https://github.com/smarquez1/smarquez1/issues/11) | Explore DeepSeek `Ask Sergio` assistant | Design a secure serverless architecture for a future AI assistant. |
